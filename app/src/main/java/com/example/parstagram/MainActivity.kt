...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 3. An ImageView to shpw the picture the user has taken
        // 4. A button to save and send the post tp our Parse server


        findViewById<Button>(R.id.button2).setOnClickListener {
            // send post to server without an image
            // Ge the description that they have inputted
        ...
        findViewById<Button>(R.id.take_picture).setOnClickListener{
            // launch camera to let users take picture
            onLaunchCamera()
        }
    }

    // Send a Post object to our Parse serve
